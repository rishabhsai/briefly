          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative group ${
                plan.popular 
                  ? 'md:scale-105 ring-2 ring-gray-300' 
                  : ''
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                  <div className="bg-gradient-to-r from-black to-gray-700 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg">
                    Most Popular
                  </div>
                </div>
              )}
        ...
        <div className="mt-20 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="text-left">
              ...
              <p className="text-black">Yes, you can cancel your subscription at any time with no questions asked.</p>
            </div>
            <div className="text-left">
              <h3 className="font-semibold mb-2 text-black">Do you offer refunds?</h3>
              <p className="text-black">We offer a 30-day money-back guarantee for all paid plans.</p>
            </div>
            <div className="text-left">
              <h3 className="font-semibold mb-2 text-black">What payment methods do you accept?</h3>
              <p className="text-black">We accept all major credit cards, PayPal, and Apple Pay.</p>
            </div>
            <div className="text-left">
              <h3 className="font-semibold mb-2 text-black">Is my data secure?</h3>
              <p className="text-black">Yes, we use enterprise-grade security and never share your data with third parties.</p>
            </div>
          </div>
        </div>
      </div>
